...
from lsst.sims.schedulerConfig.instrument import Camera, Dome, Filters, Park, ObservatoryVariation
from lsst.sims.schedulerConfig.instrument import OpticsLoopCorr, Rotator, Slew, Telescope
